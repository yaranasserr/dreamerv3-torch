...
def convert_hdf5_to_dreamer(hdf5_path, camera_key='agentview_rgb'):
    """Convert HDF5 data to format expected by Dreamer WorldModel WITHOUT rewards"""
